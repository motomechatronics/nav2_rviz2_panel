...
class WaypointsVisualization(Node):
    def __init__(self):
        ...
        self.marker_pub6 = self.create_publisher(MarkerArray,'/marker_route_direction_array',10)
    ...
    def timer_callback(self):
        ...
        self.publish_route_direction(rooms,route_id)
    ...
    def publish_route_direction(self,rooms,route_id): # insert two for cycle
        route_name,route_waypoints,routine,phases_number,route_waypoints_number = self.get_routine_data(rooms,route_id)        
        # points = rooms['points']
        ...
        marker_array2.markers.append(marker2)
        self.marker_pub6.publish(marker_array2)
        self.get_logger().info("route_direction array displayed")
