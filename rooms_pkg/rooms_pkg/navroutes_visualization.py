...
class NavRoutesVisualization(Node):
    def __init__(self):
    ...
    def timer_callback(self):
        ...
        route_id = 0
        self.publish_waypoints(rooms,route_id)
        self.publish_waypoint_numbers(rooms,route_id)  
        self.publish_phase_arrows(rooms,route_id)
        self.publish_phase_texts(rooms,route_id)        
        self.publish_phase_texts_background(rooms,route_id)      
        self.publish_routes(rooms,route_id)
        self.publish_route_directions(rooms,route_id)        
...
def main(args=None):
    ...
    navroutesviz_object = NavRoutesVisualization()
